...
#define QMC2_ADDITIONALARTWORK_COLUMN_FORMAT			6
#define QMC2_ADDITIONALARTWORK_COLUMN_FOLDER_OR_ARCHIVE		7

#define QMC2_ADDITIONALARTWORK_INDEX_TARGET_SYSTEM		0
#define QMC2_ADDITIONALARTWORK_INDEX_TARGET_SOFTWARE		1
#define QMC2_ADDITIONALARTWORK_INDEX_SCALED_ON			0
#define QMC2_ADDITIONALARTWORK_INDEX_SCALED_OFF			1
#define QMC2_ADDITIONALARTWORK_INDEX_TYPE_FOLDER		0
#define QMC2_ADDITIONALARTWORK_INDEX_TYPE_ARCHIVE		1
#define QMC2_ADDITIONALARTWORK_INDEX_FORMAT_ZIP			0
#define QMC2_ADDITIONALARTWORK_INDEX_FORMAT_7Z			1
