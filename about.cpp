...
void About::showEvent(QShowEvent *e)
{
  ...
  QString titleString =
	  ...
	  " (" + tr("SVN r%1").arg(QMC2_SVN_REV) + ")" +
          ...
          " ???" +
#endif
          "<br>" + tr("Copyright") + " &copy; 2006 - 2012 R. Reucher, " + tr("Germany") + "</p>";
  ...
  QString projectInfoString =
          ...
          "<p><b>" + tr("Bug tracking system:") + "</b><br><a href=\"http://tracker.batcom-it.net/view_all_bug_page.php\">http://tracker.batcom-it.net/view_all_bug_page.php</a></p>";
