...
#define QMC2_ROMALYZER_SRTOOL_COLUMN_ID		0
#define QMC2_ROMALYZER_SRTOOL_COLUMN_OLDID	1
#define QMC2_ROMALYZER_SRTOOL_COLUMN_MPROB	2
#define QMC2_ROMALYZER_SRTOOL_COLUMN_ACTION	3

#define QMC2_ROMALYZER_SRTOOL_AMLVL_0		0
#define QMC2_ROMALYZER_SRTOOL_AMLVL_NONE	QMC2_ROMALYZER_SRTOOL_AMLVL_0
#define QMC2_ROMALYZER_SRTOOL_AMLVL_1		1
